...
import { getAllDogs, getAllTemperaments, apiOrDbFilter, temperamentFilter, resetDog, resetDogs, resetFilter  } from '../../redux/actions';
        ...
        <div className={style.container}>
            <div>
                <ul>
                    ...
                    <li><button type='submit' onClick={clearHandler} className={style.button}>Close Filters</button></li>
                </ul>
            </div>
